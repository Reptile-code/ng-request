...
Ripple.ɵfac = function Ripple_Factory(t) {
  return new (t || Ripple)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(PrimeNGConfig, 8));
};
Ripple.ɵdir = ɵɵdefineDirective({
  type: Ripple,
  selectors: [["", "pRipple", ""]],
...
RippleModule.ɵmod = ɵɵdefineNgModule({
  type: RippleModule,
  declarations: [Ripple],
  imports: [CommonModule],
  exports: [Ripple]
});
RippleModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule]
});
(function() {
...
//# sourceMappingURL=chunk-HJHFAMDY.js.map
