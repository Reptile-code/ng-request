...
// node_modules/primeng/fesm2020/primeng-icons-home.mjs
var HomeIcon = class extends BaseIcon {
};
HomeIcon.ɵfac = function() {
  let ɵHomeIcon_BaseFactory;
  return function HomeIcon_Factory(t) {
    return (ɵHomeIcon_BaseFactory || (ɵHomeIcon_BaseFactory = ɵɵgetInheritedFactory(HomeIcon)))(t || HomeIcon);
  };
}();
HomeIcon.ɵcmp = ɵɵdefineComponent({
  type: HomeIcon,
  selectors: [["HomeIcon"]],
  standalone: true,
...
// node_modules/primeng/fesm2020/primeng-breadcrumb.mjs
function Breadcrumb_li_2_a_1_span_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ctx_r5.home.icon)("ngStyle", ctx_r5.home.iconStyle);
  }
}
function Breadcrumb_li_2_a_1_HomeIcon_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "HomeIcon", 12);
  }
  if (rf & 2) {
...
function Breadcrumb_li_2_a_1_ng_container_3_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("innerHTML", ctx_r10.home.label, ɵɵsanitizeHtml);
  }
}
function Breadcrumb_li_2_a_1_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, Breadcrumb_li_2_a_1_ng_container_3_span_1_Template, 2, 1, "span", 13);
    ɵɵtemplate(2, Breadcrumb_li_2_a_1_ng_container_3_ng_template_2_Template, 1, 1, "ng-template", null, 14, ɵɵtemplateRefExtractor);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    ...
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r7.home.escape !== false)("ngIfElse", _r9);
  }
}
function Breadcrumb_li_2_a_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function Breadcrumb_li_2_a_1_Template_a_click_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r11.itemClick($event, ctx_r11.home));
    });
    ɵɵtemplate(1, Breadcrumb_li_2_a_1_span_1_Template, 1, 2, "span", 8);
    ɵɵtemplate(2, Breadcrumb_li_2_a_1_HomeIcon_2_Template, 1, 1, "HomeIcon", 9);
    ɵɵtemplate(3, Breadcrumb_li_2_a_1_ng_container_3_Template, 4, 2, "ng-container", 10);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = ɵɵnextContext(2);
    ɵɵproperty("href", ctx_r3.home.url ? ctx_r3.home.url : null, ɵɵsanitizeUrl)("target", ctx_r3.home.target);
    ɵɵattribute("aria-label", ctx_r3.homeAriaLabel)("title", ctx_r3.home.title)("id", ctx_r3.home.id)("tabindex", ctx_r3.home.disabled ? null : "0");
    ɵɵadvance(1);
...
function Breadcrumb_li_2_a_2_ng_container_3_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("innerHTML", ctx_r18.home.label, ɵɵsanitizeHtml);
  }
}
function Breadcrumb_li_2_a_2_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, Breadcrumb_li_2_a_2_ng_container_3_span_1_Template, 2, 1, "span", 13);
    ɵɵtemplate(2, Breadcrumb_li_2_a_2_ng_container_3_ng_template_2_Template, 1, 1, "ng-template", null, 18, ɵɵtemplateRefExtractor);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    ...
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r15.home.escape !== false)("ngIfElse", _r17);
  }
}
var _c0 = function() {
  return {
...
function Breadcrumb_li_2_a_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function Breadcrumb_li_2_a_2_Template_a_click_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r19.itemClick($event, ctx_r19.home));
    });
    ɵɵtemplate(1, Breadcrumb_li_2_a_2_span_1_Template, 1, 2, "span", 8);
    ɵɵtemplate(2, Breadcrumb_li_2_a_2_HomeIcon_2_Template, 1, 1, "HomeIcon", 9);
    ɵɵtemplate(3, Breadcrumb_li_2_a_2_ng_container_3_Template, 4, 2, "ng-container", 10);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r4 = ɵɵnextContext(2);
    ɵɵproperty("routerLink", ctx_r4.home.routerLink)("queryParams", ctx_r4.home.queryParams)("routerLinkActive", "p-menuitem-link-active")("routerLinkActiveOptions", ctx_r4.home.routerLinkActiveOptions || ɵɵpureFunction0(18, _c0))("target", ctx_r4.home.target)("fragment", ctx_r4.home.fragment)("queryParamsHandling", ctx_r4.home.queryParamsHandling)("preserveFragment", ctx_r4.home.preserveFragment)("skipLocationChange", ctx_r4.home.skipLocationChange)("replaceUrl", ctx_r4.home.replaceUrl)("state", ctx_r4.home.state);
    ɵɵattribute("aria-label", ctx_r4.homeAriaLabel)("title", ctx_r4.home.title)("id", ctx_r4.home.id)("tabindex", ctx_r4.home.disabled ? null : "0");
    ɵɵadvance(1);
...
function Breadcrumb_li_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, Breadcrumb_li_2_a_1_Template, 4, 9, "a", 5);
    ɵɵtemplate(2, Breadcrumb_li_2_a_2_Template, 4, 19, "a", 6);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵclassMap(ctx_r0.home.styleClass);
    ɵɵproperty("ngClass", ɵɵpureFunction1(7, _c1, ctx_r0.home.disabled))("ngStyle", ctx_r0.home.style)("tooltipOptions", ctx_r0.home.tooltipOptions);
    ɵɵadvance(1);
...
function Breadcrumb_li_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, Breadcrumb_li_3_ChevronRightIcon_1_Template, 1, 0, "ChevronRightIcon", 10);
    ɵɵtemplate(2, Breadcrumb_li_3_2_Template, 1, 0, null, 20);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function Breadcrumb_ng_template_4_a_1_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, Breadcrumb_ng_template_4_a_1_ng_container_2_span_1_Template, 2, 1, "span", 13);
    ɵɵtemplate(2, Breadcrumb_ng_template_4_a_1_ng_container_2_ng_template_2_Template, 1, 1, "ng-template", null, 24, ɵɵtemplateRefExtractor);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    ...
    const item_r24 = ɵɵnextContext(2).$implicit;
    ɵɵadvance(1);
    ɵɵproperty("ngIf", item_r24.escape !== false)("ngIfElse", _r33);
  }
}
function Breadcrumb_ng_template_4_a_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function Breadcrumb_ng_template_4_a_1_Template_a_click_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r38.itemClick($event, item_r24));
    });
    ɵɵtemplate(1, Breadcrumb_ng_template_4_a_1_span_1_Template, 1, 2, "span", 8);
    ɵɵtemplate(2, Breadcrumb_ng_template_4_a_1_ng_container_2_Template, 4, 2, "ng-container", 10);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const item_r24 = ɵɵnextContext().$implicit;
    ɵɵproperty("target", item_r24.target);
    ɵɵattribute("href", item_r24.url ? item_r24.url : null, ɵɵsanitizeUrl)("title", item_r24.title)("id", item_r24.id)("tabindex", item_r24.disabled ? null : "0");
    ɵɵadvance(1);
...
function Breadcrumb_ng_template_4_a_2_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, Breadcrumb_ng_template_4_a_2_ng_container_2_span_1_Template, 2, 1, "span", 13);
    ɵɵtemplate(2, Breadcrumb_ng_template_4_a_2_ng_container_2_ng_template_2_Template, 1, 1, "ng-template", null, 25, ɵɵtemplateRefExtractor);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    ...
    const item_r24 = ɵɵnextContext(2).$implicit;
    ɵɵadvance(1);
    ɵɵproperty("ngIf", item_r24.escape !== false)("ngIfElse", _r46);
  }
}
function Breadcrumb_ng_template_4_a_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function Breadcrumb_ng_template_4_a_2_Template_a_click_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r51.itemClick($event, item_r24));
    });
    ɵɵtemplate(1, Breadcrumb_ng_template_4_a_2_span_1_Template, 1, 2, "span", 8);
    ɵɵtemplate(2, Breadcrumb_ng_template_4_a_2_ng_container_2_Template, 4, 2, "ng-container", 10);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const item_r24 = ɵɵnextContext().$implicit;
    ...
    ɵɵattribute("title", item_r24.title)("id", item_r24.id)("tabindex", item_r24.disabled ? null : "0");
    ɵɵadvance(1);
    ɵɵproperty("ngIf", item_r24.icon);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", item_r24.label);
...
function Breadcrumb_ng_template_4_li_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "li", 19);
    ɵɵtemplate(1, Breadcrumb_ng_template_4_li_3_ChevronRightIcon_1_Template, 1, 0, "ChevronRightIcon", 10);
    ɵɵtemplate(2, Breadcrumb_ng_template_4_li_3_2_Template, 1, 0, null, 20);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function Breadcrumb_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, Breadcrumb_ng_template_4_a_1_Template, 3, 7, "a", 22);
    ɵɵtemplate(2, Breadcrumb_ng_template_4_a_2_Template, 3, 17, "a", 6);
    ɵɵelementEnd();
    ɵɵtemplate(3, Breadcrumb_ng_template_4_li_3_Template, 3, 2, "li", 2);
  }
  if (rf & 2) {
    const item_r24 = ctx.$implicit;
    const end_r25 = ctx.last;
    ɵɵclassMap(item_r24.styleClass);
    ɵɵproperty("ngStyle", item_r24.style)("ngClass", ɵɵpureFunction1(8, _c2, item_r24.disabled))("tooltipOptions", item_r24.tooltipOptions);
    ɵɵadvance(1);
...
Breadcrumb.ɵcmp = ɵɵdefineComponent({
  ...
  template: function Breadcrumb_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(2, Breadcrumb_li_2_Template, 3, 9, "li", 1);
      ɵɵtemplate(3, Breadcrumb_li_3_Template, 3, 2, "li", 2);
      ɵɵtemplate(4, Breadcrumb_ng_template_4_Template, 4, 10, "ng-template", 3);
      ɵɵelementEnd()();
    }
    if (rf & 2) {
  ...
  dependencies: function() {
    return [NgClass, NgForOf, NgIf, NgTemplateOutlet, NgStyle, RouterLink, RouterLinkActive, Tooltip, ChevronRightIcon, HomeIcon];
  },
