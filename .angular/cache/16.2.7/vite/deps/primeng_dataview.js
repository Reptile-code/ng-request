import {
  Paginator,
  PaginatorModule
} from "./chunk-W7IGDRY3.js";
import "./chunk-QFDGHSL6.js";
import "./chunk-JFU3Z4IM.js";
import "./chunk-BGN3WWXG.js";
import "./chunk-K4PCLLZO.js";
import "./chunk-D7ZDM4UO.js";
import "./chunk-Y57JNKG3.js";
import "./chunk-OBMMJG6Q.js";
import {
  SpinnerIcon
} from "./chunk-6KAAALNF.js";
import "./chunk-NTW4LXS3.js";
import "./chunk-HJHFAMDY.js";
import {
  BaseIcon
...
// node_modules/primeng/fesm2020/primeng-icons-thlarge.mjs
var ThLargeIcon = class extends BaseIcon {
};
ThLargeIcon.ɵfac = function() {
  let ɵThLargeIcon_BaseFactory;
  return function ThLargeIcon_Factory(t) {
    return (ɵThLargeIcon_BaseFactory || (ɵThLargeIcon_BaseFactory = ɵɵgetInheritedFactory(ThLargeIcon)))(t || ThLargeIcon);
  };
}();
ThLargeIcon.ɵcmp = ɵɵdefineComponent({
  type: ThLargeIcon,
...
// node_modules/primeng/fesm2020/primeng-icons-bars.mjs
var BarsIcon = class extends BaseIcon {
};
BarsIcon.ɵfac = function() {
  let ɵBarsIcon_BaseFactory;
  return function BarsIcon_Factory(t) {
    return (ɵBarsIcon_BaseFactory || (ɵBarsIcon_BaseFactory = ɵɵgetInheritedFactory(BarsIcon)))(t || BarsIcon);
  };
}();
BarsIcon.ɵcmp = ɵɵdefineComponent({
  type: BarsIcon,
  selectors: [["BarsIcon"]],
  standalone: true,
  features: [ɵɵInheritDefinitionFeature, ɵɵStandaloneFeature],
...
// node_modules/primeng/fesm2020/primeng-dataview.mjs
...
function DataView_div_1_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, DataView_div_1_ng_container_3_SpinnerIcon_1_Template, 1, 2, "SpinnerIcon", 14);
    ɵɵtemplate(2, DataView_div_1_ng_container_3_2_Template, 1, 0, null, 15);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
function DataView_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, DataView_div_1_i_2_Template, 1, 2, "i", 12);
    ɵɵtemplate(3, DataView_div_1_ng_container_3_Template, 3, 2, "ng-container", 13);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
...
function DataView_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵprojection(1);
    ɵɵtemplate(2, DataView_div_2_ng_container_2_Template, 1, 0, "ng-container", 15);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function DataView_p_paginator_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵelementStart(0, "p-paginator", 18);
...
function DataView_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, DataView_ng_template_6_ng_container_0_Template, 1, 0, "ng-container", 19);
  }
  if (rf & 2) {
    const rowData_r15 = ctx.$implicit;
    const rowIndex_r16 = ctx.index;
    const ctx_r3 = ɵɵnextContext();
    ɵɵproperty("ngTemplateOutlet", ctx_r3.itemTemplate)("ngTemplateOutletContext", ɵɵpureFunction2(2, _c0, rowData_r15, rowIndex_r16));
  }
}
function DataView_div_8_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", ctx_r18.emptyMessageLabel, " ");
  }
}
function DataView_div_8_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0, null, 23);
  }
}
function DataView_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 20)(1, "div", 21);
    ɵɵtemplate(2, DataView_div_8_ng_container_2_Template, 2, 1, "ng-container", 22);
    ɵɵtemplate(3, DataView_div_8_ng_container_3_Template, 2, 0, "ng-container", 15);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r4 = ɵɵnextContext();
    ɵɵadvance(2);
    ɵɵproperty("ngIf", !ctx_r4.emptyMessageTemplate)("ngIfElse", ctx_r4.emptyFilter);
    ɵɵadvance(1);
...
function DataView_p_paginator_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("onPageChange", function DataView_p_paginator_9_Template_p_paginator_onPageChange_0_listener($event) {
      ɵɵrestoreView(_r22);
      const ctx_r21 = ɵɵnextContext();
      return ɵɵresetView(ctx_r21.paginate($event));
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function DataView_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵprojection(1, 1);
    ɵɵtemplate(2, DataView_div_10_ng_container_2_Template, 1, 0, "ng-container", 15);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
DataView.ɵfac = function DataView_Factory(t) {
  return new (t || DataView)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(FilterService), ɵɵdirectiveInject(PrimeNGConfig));
};
DataView.ɵcmp = ɵɵdefineComponent({
  type: DataView,
  ...
  template: function DataView_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(1, DataView_div_1_Template, 4, 2, "div", 1);
      ɵɵtemplate(2, DataView_div_2_Template, 3, 1, "div", 2);
      ɵɵtemplate(3, DataView_p_paginator_3_Template, 1, 16, "p-paginator", 3);
      ɵɵelementStart(4, "div", 4)(5, "div", 5);
      ɵɵtemplate(6, DataView_ng_template_6_Template, 1, 5, "ng-template", 6);
      ɵɵpipe(7, "slice");
      ɵɵtemplate(8, DataView_div_8_Template, 4, 3, "div", 7);
      ɵɵelementEnd()();
      ɵɵtemplate(9, DataView_p_paginator_9_Template, 1, 16, "p-paginator", 8);
      ɵɵtemplate(10, DataView_div_10_Template, 3, 1, "div", 9);
      ɵɵelementEnd();
    }
    if (rf & 2) {
      ɵɵclassMap(ctx.styleClass);
      ɵɵproperty("ngClass", ɵɵpureFunction2(17, _c2, ctx.layout === "list", ctx.layout === "grid"))("ngStyle", ctx.style);
      ɵɵadvance(1);
      ...
      ɵɵadvance(2);
      ɵɵproperty("ngClass", ctx.gridStyleClass);
      ɵɵadvance(1);
      ɵɵproperty("ngForOf", ctx.paginator ? ɵɵpipeBind3(7, 13, ctx.filteredValue || ctx.value, ctx.lazy ? 0 : ctx.first, (ctx.lazy ? 0 : ctx.first) + ctx.rows) : ctx.filteredValue || ctx.value)("ngForTrackBy", ctx.trackBy);
      ɵɵadvance(2);
  ...
  dependencies: function() {
    return [NgClass, NgForOf, NgIf, NgTemplateOutlet, NgStyle, Paginator, SpinnerIcon, SlicePipe];
  },
...
var DataViewLayoutOptions = class {
  constructor(dv) {
    this.dv = dv;
  }
...
DataViewLayoutOptions.ɵfac = function DataViewLayoutOptions_Factory(t) {
  return new (t || DataViewLayoutOptions)(ɵɵdirectiveInject(DataView));
};
DataViewLayoutOptions.ɵcmp = ɵɵdefineComponent({
  ...
  template: function DataViewLayoutOptions_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(2, DataViewLayoutOptions_BarsIcon_2_Template, 1, 0, "BarsIcon", 2);
      ɵɵtemplate(3, DataViewLayoutOptions_3_Template, 1, 0, null, 3);
      ɵɵelementEnd();
      ...
      ɵɵtemplate(5, DataViewLayoutOptions_ThLargeIcon_5_Template, 1, 0, "ThLargeIcon", 2);
      ɵɵtemplate(6, DataViewLayoutOptions_6_Template, 1, 0, null, 3);
      ɵɵelementEnd()();
    }
    if (rf & 2) {
      ɵɵclassMap(ctx.styleClass);
  ...
  dependencies: function() {
    return [NgClass, NgIf, NgTemplateOutlet, NgStyle, BarsIcon, ThLargeIcon];
  },
  encapsulation: 2
});
(function() {
